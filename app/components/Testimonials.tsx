        ...
        <div className={style.testimonialsWrapper}>
          <div className={style.testimonialItem}>
            <div className={style.testimonialContent}>
              ...
              <p className={style.testimonialText}>
                "Working with Raza was a game-changer for our brand. His designs
          ...
          <div className={style.testimonialItem}>
            <div className={style.testimonialContent}>
              ...
              />
              <p className={style.testimonialText}>
                "Raza built a website for my business that exceeded my expectations.
          ...
          <div className={style.testimonialItem}>
            <div className={style.testimonialContent}>
              ...
              />
              <p className={style.testimonialText}>
                "The UI/UX design Raza created for our app was phenomenal. He took
              ...
              <span className={style.divider}></span>
              <h2 className={style.clientName}>Olivia Martinez</h2>
